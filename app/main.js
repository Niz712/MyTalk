...
function init() {
  ...
  // init contracts
  $.getJSON('MyTalk.json', function(data) {
      // Get the necessary contract artifact file and instantiate it with truffle-contract.
      var MyTalkArtifact = data

      try {
         contracts.MyTalk = TruffleContract(MyTalkArtifact)

        // Set the provider for our contract.
        contracts.MyTalk.setProvider(web3Provider)
...
function checkAccount() {
  web3.eth.getAccounts(function(error, accounts) {
        ...
        contracts.MyTalk.deployed().then(function(_instance) {
            instance = _instance
